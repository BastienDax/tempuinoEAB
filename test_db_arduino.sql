...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.1&nocache=2547317324ltr&server=1">
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/printview.css?v=5.1.1" media="print" id="printcss">
    <title>localhost / MySQL | phpMyAdmin 5.1.1</title>
  ...
  <script data-cfasync="false" type="text/javascript" src="js/messages.php?l=fr&v=5.1.1"></script>
...
CommonParams.setAll({common_query:"",opendb_url:"index.php?route=/database/structure",lang:"fr",server:"1",table:"",db:"",token:"50277b71563376517070423e53272723",text_dir:"ltr",show_databases_navigation_as_tree:true,pma_text_default_tab:"Parcourir",pma_text_left_default_tab:"Structure",pma_text_left_default_tab2:false,LimitChars:"50",pftext:"P",confirm:true,LoginCookieValidity:"1440",session_gc_maxlifetime:"1440",logged_in:true,is_https:false,rootPath:"/phpmyadmin/",arg_separator:"&",PMA_VERSION:"5.1.1",auth_type:"cookie",user:"root"});
      ...
      <div id="pma_navigation_header">
        ...
        <div id="navipanellinks">
          ...
          <a id="pma_navigation_reload" href="#" title="Recharger le panneau de navigation"><img src="themes/dot.gif" title="Recharger le panneau de navigation" alt="Recharger le panneau de navigation" class="icon ic_s_reload"></a>
                  ...
                  <div id="serverChoice">
            <form method="post" action="index.php?route=/" class="disableAjax"><input type="hidden" name="token" value="50277b71563376517070423e53272723"><label for="select_server">Serveur courant :</label> <select name="server" id="select_server" class="autosubmit"><option value="">(Serveurs) ...</option>
...
<option value="2" >MariaDB</option>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Tables récentes" class="drop_button btn">Récentes</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=test_db_arduino&table=temp">`test_db_arduino`.`temp`</a></li></ul></div><div class="drop_list"><button title="Tables préférées" class="drop_button btn">Préférées</button><ul id="pma_favorite_list"><li class="warp_link">Pas de tables préférées.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="50277b71563376517070423e53272723">
...
<nav id="server-breadcrumb" aria-label="breadcrumb">
  <ol class="breadcrumb">
    <li class="breadcrumb-item">
      ...
      <a href="index.php?route=/" data-raw-text="MySQL:3306">
        Serveur :        MySQL:3306
      </a>
    </li>
